...
#define GEN_GL_STATE_STRUCT(PNAME, TYPE) \
namespace GLStates { \
    struct PNAME {\
        static const GLenum Value = GL_##PNAME; \
        using ReturnType = TYPE; \
        static TYPE get(); \
    }; \
}

#define GEN_GL_STATE_STRUCT_INDEXED(PNAME, TYPE) \
namespace GLStates { \
    struct PNAME {\
        static const GLenum Value = GL_##PNAME; \
        using ReturnType = TYPE; \
        static TYPE get(); \
        static TYPE get(GLuint index); \
    }; \
}

#define GEN_GL_STATE_IMPL(PNAME, TYPE) \
namespace GLStates { \
    TYPE PNAME::get() { \
        return GLGetParameterHelper<TYPE>::get(GL_##PNAME); \
    } \
}

#define GEN_GL_STATE_IMPL_INDEXED(PNAME, TYPE) \
namespace GLStates { \
    TYPE PNAME::get() { \
        return GLGetParameterHelper<TYPE>::get(GL_##PNAME); \
    } \
    TYPE PNAME::get(GLuint index) { \
        return GLGetParameterHelper<TYPE>::get(GL_##PNAME, index); \
    } \
}

#define GEN_GL_STATE_IMPL_INT_VECTOR(PNAME, TYPE, GL_STATE_RETURNING_SIZE) \
namespace GLStates { \
	TYPE PNAME::get() { \
		TYPE values(GLStates::GL_STATE_RETURNING_SIZE::get()); \
		glGetIntegerv(Value, values.data()); \
		return values; \
    } \
}

GEN_GL_STATE_STRUCT(GPU_MEMORY_INFO_TOTAL_AVAILABLE_MEMORY_NVX, GLint)
GEN_GL_STATE_STRUCT(GPU_MEMORY_INFO_CURRENT_AVAILABLE_VIDMEM_NVX, GLint)

// Extracted from https://www.opengl.org/sdk/docs/man/html/glGet.xhtml :

GEN_GL_STATE_STRUCT(ACTIVE_TEXTURE, GLint)
// data returns a single value indicating the active multitexture unit. The initial value is GL_TEXTURE0. See glActiveTexture.

GEN_GL_STATE_STRUCT(ALIASED_LINE_WIDTH_RANGE, GLfloat2)
// data returns a pair of values indicating the range of widths supported for aliased lines. See glLineWidth.

GEN_GL_STATE_STRUCT(ARRAY_BUFFER_BINDING, GLint)
...
GEN_GL_STATE_STRUCT(BLEND_DST_ALPHA, GLint)
...
GEN_GL_STATE_STRUCT(BLEND_DST_RGB, GLint)
...
GEN_GL_STATE_STRUCT(BLEND_EQUATION_RGB, GLint)
...
GEN_GL_STATE_STRUCT(BLEND_EQUATION_ALPHA, GLint)
...
GEN_GL_STATE_STRUCT(BLEND_SRC_ALPHA, GLint)
...
GEN_GL_STATE_STRUCT(BLEND_SRC_RGB, GLint)
...
GEN_GL_STATE_STRUCT(COLOR_CLEAR_VALUE, GLfloat4)
...
GEN_GL_STATE_STRUCT(COLOR_LOGIC_OP, GLboolean)
...
GEN_GL_STATE_STRUCT(COLOR_WRITEMASK, GLint4)
...
GEN_GL_STATE_STRUCT(MAX_COMPUTE_SHADER_STORAGE_BLOCKS, GLint)
// data returns one value, the maximum number of active shader storage blocks that may be accessed by a compute shader.

GEN_GL_STATE_STRUCT(MAX_COMBINED_SHADER_STORAGE_BLOCKS, GLint)
...
GEN_GL_STATE_STRUCT(MAX_COMPUTE_UNIFORM_BLOCKS, GLint)
...
GEN_GL_STATE_STRUCT(MAX_COMPUTE_TEXTURE_IMAGE_UNITS, GLint)
...
GEN_GL_STATE_STRUCT(MAX_COMPUTE_UNIFORM_COMPONENTS, GLint)
...
GEN_GL_STATE_STRUCT(MAX_COMPUTE_WORK_GROUP_INVOCATIONS, GLint)
...
GEN_GL_STATE_STRUCT_INDEXED(MAX_COMPUTE_WORK_GROUP_COUNT, GLint)
...
GEN_GL_STATE_STRUCT_INDEXED(MAX_COMPUTE_WORK_GROUP_SIZE, GLint)
...
GEN_GL_STATE_STRUCT(DISPATCH_INDIRECT_BUFFER_BINDING, GLint)
...
GEN_GL_STATE_STRUCT(CURRENT_PROGRAM, GLint)
...
GEN_GL_STATE_STRUCT(DEPTH_CLEAR_VALUE, GLfloat)
...
GEN_GL_STATE_STRUCT(DEPTH_FUNC, GLint)
...
GEN_GL_STATE_STRUCT(DEPTH_RANGE, GLfloat2)
...
GEN_GL_STATE_STRUCT(DEPTH_TEST, GLboolean)
...
GEN_GL_STATE_STRUCT(DEPTH_WRITEMASK, GLboolean)
...
GEN_GL_STATE_STRUCT(DITHER, GLboolean)
...
//GEN_GL_STATE_STRUCT(DRAW_BUFFER i
...
GEN_GL_STATE_STRUCT(DRAW_FRAMEBUFFER_BINDING, GLint)
...
GEN_GL_STATE_STRUCT(READ_FRAMEBUFFER_BINDING, GLint)
...
GEN_GL_STATE_STRUCT(ELEMENT_ARRAY_BUFFER_BINDING, GLint)
...
GEN_GL_STATE_STRUCT(FRAGMENT_SHADER_DERIVATIVE_HINT, GLint)
...
GEN_GL_STATE_STRUCT(LINE_SMOOTH_HINT, GLint)
...
GEN_GL_STATE_STRUCT(LOGIC_OP_MODE, GLint)
...
GEN_GL_STATE_STRUCT(MAX_ARRAY_TEXTURE_LAYERS, GLint)
...
GEN_GL_STATE_STRUCT(MAX_COMBINED_GEOMETRY_UNIFORM_COMPONENTS, GLint)
...
GEN_GL_STATE_STRUCT(MAX_COMBINED_TEXTURE_IMAGE_UNITS, GLint)
...
GEN_GL_STATE_STRUCT(MAX_COMBINED_UNIFORM_BLOCKS, GLint)
...
GEN_GL_STATE_STRUCT(MAX_COMBINED_VERTEX_UNIFORM_COMPONENTS, GLint)
...
GEN_GL_STATE_STRUCT(MAX_CUBE_MAP_TEXTURE_SIZE, GLint)
...
GEN_GL_STATE_STRUCT(MAX_DUAL_SOURCE_DRAW_BUFFERS, GLint)
...
GEN_GL_STATE_STRUCT(MAX_FRAGMENT_UNIFORM_COMPONENTS, GLint)
...
GEN_GL_STATE_STRUCT(MAX_FRAGMENT_UNIFORM_VECTORS, GLint)
...
GEN_GL_STATE_STRUCT(MAX_FRAGMENT_UNIFORM_BLOCKS, GLint)
...
GEN_GL_STATE_STRUCT(MAX_FRAMEBUFFER_WIDTH, GLint)
...
GEN_GL_STATE_STRUCT(MAX_FRAMEBUFFER_HEIGHT, GLint)
...
GEN_GL_STATE_STRUCT(MAX_FRAMEBUFFER_LAYERS, GLint)
...
GEN_GL_STATE_STRUCT(MAX_FRAMEBUFFER_SAMPLES, GLint)
...
GEN_GL_STATE_STRUCT(MAX_GEOMETRY_TEXTURE_IMAGE_UNITS, GLint)
...
GEN_GL_STATE_STRUCT(MAX_GEOMETRY_UNIFORM_BLOCKS, GLint)
...
GEN_GL_STATE_STRUCT(MAX_GEOMETRY_UNIFORM_COMPONENTS, GLint)
...
GEN_GL_STATE_STRUCT(MAX_LABEL_LENGTH, GLint)
...
GEN_GL_STATE_STRUCT(MAX_TESS_EVALUATION_SHADER_STORAGE_BLOCKS, GLint)
...
GEN_GL_STATE_STRUCT(MAX_TEXTURE_BUFFER_SIZE, GLint)
...
GEN_GL_STATE_STRUCT(MAX_TEXTURE_IMAGE_UNITS, GLint)
...
GEN_GL_STATE_STRUCT(MAX_VARYING_FLOATS, GLint)
...
GEN_GL_STATE_STRUCT(MAX_VERTEX_ATOMIC_COUNTERS, GLint)
// data returns a single value, the maximum number of atomic counters available to vertex shaders.

GEN_GL_STATE_STRUCT(MAX_VERTEX_ATTRIBS, GLint)
...
GEN_GL_STATE_STRUCT(MAX_VERTEX_SHADER_STORAGE_BLOCKS, GLint)
// data returns one value, the maximum number of active shader storage blocks that may be accessed by a vertex shader.

GEN_GL_STATE_STRUCT(MAX_VERTEX_TEXTURE_IMAGE_UNITS, GLint)
...
GEN_GL_STATE_STRUCT(MAX_VERTEX_UNIFORM_COMPONENTS, GLint)
...
GEN_GL_STATE_STRUCT(MAX_VERTEX_UNIFORM_VECTORS, GLint)
...
GEN_GL_STATE_STRUCT(MAX_VIEWPORT_DIMS, GLint2)
...
GEN_GL_STATE_STRUCT(MAX_VIEWPORTS, GLint)
...
GEN_GL_STATE_STRUCT(NUM_EXTENSIONS, GLint)
...
GEN_GL_STATE_STRUCT(NUM_PROGRAM_BINARY_FORMATS, GLint)
// data returns one value, the number of program binary formats supported by the implementation.

GEN_GL_STATE_STRUCT(NUM_SHADER_BINARY_FORMATS, GLint)
...
GEN_GL_STATE_STRUCT(PACK_SKIP_PIXELS, GLint)
...
GEN_GL_STATE_STRUCT(PACK_SKIP_ROWS, GLint)
...
GEN_GL_STATE_STRUCT(PACK_SWAP_BYTES, GLboolean)
...
GEN_GL_STATE_STRUCT(PIXEL_PACK_BUFFER_BINDING, GLint)
...
GEN_GL_STATE_STRUCT(PIXEL_UNPACK_BUFFER_BINDING, GLint)
...
GEN_GL_STATE_STRUCT(PROGRAM_POINT_SIZE, GLboolean)
...
GEN_GL_STATE_STRUCT(PROVOKING_VERTEX, GLint)
...
GEN_GL_STATE_STRUCT(POLYGON_OFFSET_FACTOR, GLfloat)
...
GEN_GL_STATE_STRUCT(POLYGON_OFFSET_UNITS, GLfloat)
...
GEN_GL_STATE_STRUCT(POLYGON_OFFSET_FILL, GLboolean)
...
GEN_GL_STATE_STRUCT(POLYGON_OFFSET_LINE, GLboolean)
...
GEN_GL_STATE_STRUCT(POLYGON_OFFSET_POINT, GLboolean)
...
GEN_GL_STATE_STRUCT(POLYGON_SMOOTH, GLboolean)
...
GEN_GL_STATE_STRUCT(POLYGON_SMOOTH_HINT, GLint)
...
GEN_GL_STATE_STRUCT(READ_BUFFER, GLint)
...
GEN_GL_STATE_STRUCT(RENDERBUFFER_BINDING, GLint)
...
GEN_GL_STATE_STRUCT(SAMPLE_BUFFERS, GLint)
...
GEN_GL_STATE_STRUCT_INDEXED(SHADER_STORAGE_BUFFER_BINDING, GLint)
...
GEN_GL_STATE_STRUCT(SHADER_STORAGE_BUFFER_OFFSET_ALIGNMENT, GLint)
...
GEN_GL_STATE_STRUCT_INDEXED(SHADER_STORAGE_BUFFER_START, GLint64)
...
GEN_GL_STATE_STRUCT_INDEXED(SHADER_STORAGE_BUFFER_SIZE, GLint64)
...
GEN_GL_STATE_STRUCT(STENCIL_BACK_FUNC, GLint)
...
GEN_GL_STATE_STRUCT(STENCIL_BACK_PASS_DEPTH_FAIL, GLint)
...
GEN_GL_STATE_STRUCT(STENCIL_BACK_PASS_DEPTH_PASS, GLint)
...
GEN_GL_STATE_STRUCT(STENCIL_BACK_REF, GLint)
...
GEN_GL_STATE_STRUCT(STENCIL_BACK_VALUE_MASK, GLint)
...
GEN_GL_STATE_STRUCT(STENCIL_BACK_WRITEMASK, GLint)
...
GEN_GL_STATE_STRUCT(STENCIL_FUNC, GLint)
...
GEN_GL_STATE_STRUCT(STENCIL_PASS_DEPTH_FAIL, GLint)
...
GEN_GL_STATE_STRUCT(STENCIL_PASS_DEPTH_PASS, GLint)
...
GEN_GL_STATE_STRUCT(STENCIL_REF, GLint)
...
GEN_GL_STATE_STRUCT(STENCIL_TEST, GLboolean)
...
GEN_GL_STATE_STRUCT(STENCIL_VALUE_MASK, GLint)
...
GEN_GL_STATE_STRUCT(STENCIL_WRITEMASK, GLint)
...
GEN_GL_STATE_STRUCT(TEXTURE_BINDING_1D, GLint)
...
GEN_GL_STATE_STRUCT(TEXTURE_BINDING_1D_ARRAY, GLint)
...
GEN_GL_STATE_STRUCT(TEXTURE_BINDING_2D, GLint)
...
GEN_GL_STATE_STRUCT(TEXTURE_BINDING_2D_ARRAY, GLint)
...
GEN_GL_STATE_STRUCT(TEXTURE_BINDING_2D_MULTISAMPLE, GLint)
...
GEN_GL_STATE_STRUCT(TEXTURE_BINDING_2D_MULTISAMPLE_ARRAY, GLint)
...
GEN_GL_STATE_STRUCT(TEXTURE_BINDING_3D, GLint)
...
GEN_GL_STATE_STRUCT(TEXTURE_BINDING_BUFFER, GLint)
...
GEN_GL_STATE_STRUCT(TEXTURE_BINDING_CUBE_MAP, GLint)
...
GEN_GL_STATE_STRUCT(TEXTURE_BINDING_RECTANGLE, GLint)
...
GEN_GL_STATE_STRUCT(TIMESTAMP, GLint64)
// data returns a single value, the 64-bit value of the current GL time. See glQueryCounter.

GEN_GL_STATE_STRUCT_INDEXED(TRANSFORM_FEEDBACK_BUFFER_BINDING, GLint)
...
GEN_GL_STATE_STRUCT_INDEXED(TRANSFORM_FEEDBACK_BUFFER_START, GLint64)
...
GEN_GL_STATE_STRUCT_INDEXED(TRANSFORM_FEEDBACK_BUFFER_SIZE, GLint64)
...
GEN_GL_STATE_STRUCT_INDEXED(UNIFORM_BUFFER_BINDING, GLint)
...
GEN_GL_STATE_STRUCT(UNIFORM_BUFFER_OFFSET_ALIGNMENT, GLint)
...
GEN_GL_STATE_STRUCT_INDEXED(UNIFORM_BUFFER_SIZE, GLint64)
...
GEN_GL_STATE_STRUCT_INDEXED(UNIFORM_BUFFER_START, GLint64)
...
GEN_GL_STATE_STRUCT(UNPACK_ALIGNMENT, GLint)
...
GEN_GL_STATE_STRUCT(UNPACK_SKIP_PIXELS, GLint)
...
GEN_GL_STATE_STRUCT(UNPACK_SKIP_ROWS, GLint)
...
GEN_GL_STATE_STRUCT(UNPACK_SWAP_BYTES, GLboolean)
...
GEN_GL_STATE_STRUCT(VERTEX_ARRAY_BINDING, GLint)
...
GEN_GL_STATE_STRUCT_INDEXED(VERTEX_BINDING_DIVISOR, GLint)
...
GEN_GL_STATE_STRUCT_INDEXED(VERTEX_BINDING_OFFSET, GLint)
...
GEN_GL_STATE_STRUCT_INDEXED(VERTEX_BINDING_STRIDE, GLint)
...
GEN_GL_STATE_STRUCT(VIEWPORT_SUBPIXEL_BITS, GLint)
...
GEN_GL_STATE_STRUCT(MAX_ELEMENT_INDEX, GLint)
...
GEN_GL_STATE_STRUCT(COMPRESSED_TEXTURE_FORMATS, std::vector<GLint>)
...
GEN_GL_STATE_STRUCT(PROGRAM_BINARY_FORMATS, std::vector<GLint>)
...
inline GLint getGPUMemoryInfoTotalAvailable() {
    return GLStates::GPU_MEMORY_INFO_TOTAL_AVAILABLE_MEMORY_NVX::get();
}

inline GLint getGPUMemoryInfoCurrentAvailable() {
    return GLStates::GPU_MEMORY_INFO_CURRENT_AVAILABLE_VIDMEM_NVX::get();
}

inline GLint getMaxArrayTextureLayers() {
    return GLStates::MAX_ARRAY_TEXTURE_LAYERS::get();
}
