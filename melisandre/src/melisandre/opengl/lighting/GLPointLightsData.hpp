...
#include <melisandre/opengl/cube_mapping/GLCubeMapContainer.hpp>
#include <melisandre/opengl/cube_mapping/GLCubeMapRenderPass.hpp>
#include <melisandre/scene/lights/PointLight.hpp>
